...
02_questions_06_v2, it will be an altered version from 02_questions_06_v1 and
once the question for that region has been answered, if the
answer is correct/incorrect, it will highlight the region button red/green
instead of grey."""
