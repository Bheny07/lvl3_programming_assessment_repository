...
button, play gain button and a close button. In this version, 03_03, will
allow the user to export results into a pdf file. Will do this by downloading
reportlab in console and create a function to export results"""
