...
button, play gain button and a close button. In this version, 03_01, It will
display an end screen for the user and tell them the amount of
correct/incorrect answers and a percentage."""
